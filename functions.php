    ...
    function block_1($caption, $content) {
            ...
            <div class="u-block">
                  <div class="u-block-container u-clearfix"><!--block_header-->
                    <?php if ($hasCaption) : ?><h5 class="u-block-header u-text u-text-1"><?php echo $caption; ?></h5><?php endif; ?><!--/block_header--><!--block_content-->
                    <?php if ($hasContent) : ?><div class="u-block-content u-text u-text-2"><?php echo $content; ?></div><?php endif; ?><!--/block_content-->
                  </div>
                </div>
            <?php
            return ob_get_clean();
...
function block_2($caption, $content) {
            ...
            <div class="u-block">
                  <div class="u-block-container u-clearfix"><!--block_header-->
                    <?php if ($hasCaption) : ?><h5 class="u-block-header u-text u-text-3"><?php echo $caption; ?></h5><?php endif; ?><!--/block_header--><!--block_content-->
                    <?php if ($hasContent) : ?><div class="u-block-content u-text u-text-4"><?php echo $content; ?></div><?php endif; ?><!--/block_content-->
                  </div>
                </div>
            <?php
            return ob_get_clean();
...
function block_3($caption, $content) {
            ...
            <div class="u-block">
                  <div class="u-block-container u-clearfix"><!--block_header-->
                    <?php if ($hasCaption) : ?><h5 class="u-block-header u-text u-text-5"><?php echo $caption; ?></h5><?php endif; ?><!--/block_header--><!--block_content-->
                    <?php if ($hasContent) : ?><div class="u-block-content u-text u-text-6"><?php echo $content; ?></div><?php endif; ?><!--/block_content-->
                  </div>
                </div>
            <?php
            return ob_get_clean();
